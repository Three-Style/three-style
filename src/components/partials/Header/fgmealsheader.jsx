  ...
  return (
    <>
      <a
        ...
        onClick={scrollToTop} aria-label="Fg Group"
      >
        <ArrowCircleUpIcon className="fs-50" />
      </a>
      <a className="inquiry" aria-label="Fg Group">
