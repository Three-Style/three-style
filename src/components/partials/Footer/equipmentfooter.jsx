          ...
          <div className="container ">
            <div className="row ">
              <div className="col-md-3 f1 f2">
                <h2 className="h4-fs">Gomzi Equipment</h2>
                <p>
                  Upgrade your workouts with top-quality fitness equipment and gym essentials for a powerful training experience!
                </p>
              </div>
