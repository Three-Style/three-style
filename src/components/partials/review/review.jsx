...
function ReviewSection({ book_id }) {
  ...
  const getBookFeedback = () => {
    publicAxiosInstance
      .get(`/feedback/books?book_id=${book_id}`)
      .then((response) => {
        const { data } = response;
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-md-3 revi">
                ...
                <h2 className="h5-fs" id="div_overall_rating">
                  {averageRating}
                </h2>
                <div className="mt-2 mb-3 mel mb-2">
                  {[1, 2, 3, 4, 5].map((value) => (
                    <i
                      key={value}
                  ...
                  <p id="div_total_review" className="mt-2 mb-3">
                ...
                <div className="revi" id="div_review_codeblock">
                  {reviews.map((feedback, index) => (
                    <div key={index} className="mt-2 mb-5 meal">
                      <p className="d-inline-block mt-0">
