              ...
              <div className="table-responsive fs-md mb-4">
                <table className="table table-bordered table-hover mb-0">
                  <thead className="text-700 bg-gray-200">
                    <tr>
                      <th className="fw-600">Ticket Subject</th>
                      <th className="fw-600">Date Submitted</th>
                      <th className="fw-600">Type</th>
                      <th className="fw-600">Priority</th>
                      <th className="fw-600 text-end">Status</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="p-3">
                        <span className="fw-500">Order is not delivered</span>
                      </td>
                      <td className="p-3">May 21, 2021</td>
                      <td className="p-3">Delivered</td>
                      <td className="p-3">
                        <span className="badge bg-danger m-0">High</span>
                      </td>
                      <td className="p-3 text-end">
                        <span className="badge bg-success m-0">Open</span>
                      </td>
                    </tr>
                    <tr>
                      <td className="p-3">
                      ...
                      <td className="p-3">Delivered</td>
                      <td className="p-3">
                        <span className="badge bg-warning m-0">Medium</span>
                      </td>
                      <td className="p-3 text-end">
                        <span className="badge bg-danger m-0">Suspended</span>
                      </td>
                    </tr>
                    <tr>
                      <td className="p-3">
                      ...
                      <td className="p-3">Delivered</td>
                      <td className="p-3">
                        <span className="badge bg-secondary m-0">Low</span>
                      </td>
                      <td className="p-3 text-end">
                        <span className="badge bg-gray-400 text-mode m-0">
                          Close
                        </span>
                      </td>
                    </tr>
