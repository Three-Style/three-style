...
function UserOrder() {
        ...
        if (response.data.data && response.data.data.length > 0) {
          const productResponse = response.data.data?.map((responseData) => {
            const productItemData = responseData.multiple_items?.map((item) => {
              const productData = responseData.books.find(
              ...
              return {
                ...
                book_title: productData?.book_title || "Unknown",
  ...
  // const getImage = (name) => {
  //     switch (name) {
  //         case 'Diploma In Personal Training Course':
  //             return 'cpt-1.webp';
  //             break;

  //         case 'Diploma In Nutrition Course':
  //             return 'cnc-1.jpg';
  //             break;
  //         case 'Anabolic Androgenic Steroids':
  //             return 'aas-1.webp';
  //             break;
  //         case 'Rapid Transformation Program':
  //             return 'rtp-1.webp';
  //             break;
  //         case 'Injury Rehab':
  //             return 'injury-rehab-2.webp';
  //             break;
  //         default:
  //             return 'cpt-1.webp';
  //             break;
  ...
  return (
    <>
      ...
      >
        <section>
          <div className="Info">
            <h1 className="h2-fs">Product Details</h1>
          </div>
            ...
            <div key={index} className="row border pb-4 rounded mt-5">
              ...
              {order.items !== undefined &&
                order.items?.map((ItemDetails, index) => (
                  <div
                    key={index}
                    className="col-md-12 mt-2 p-2 user-order justify-content-center"
                  >
              ...
              {order.items == undefined &&
                order.books?.map((ItemDetails, index) => (
                  <div key={index} className="col-md-8 mt-2 meal">
                    <div className="Grocery2 float-left mt-3 w-100">
                      ...
                      <div className="price1">
                        ...
                        <span className="q1 ml-4">Quantity : 1 </span>
                      </div>
                    </div>
                  </div>
                ))}
              ...
              {order.user_book?.tracking &&
                order.user_book?.tracking.length > 0 && (
        ...
        <section className="margintop">
          <div className="describe text-center">
            <h2 className="h1-fs">terms & conditions</h2>
          ...
          <div className="describe">
            ...
            <p>
              <h2
                className="text-dark h4-fs fs-20"
                style={{
                  fontWeight: "600",
                  fontFamily: "roboto",
                }}
            ...
            <p>
              <h2 className="text-dark h4-fs fs-20" 
                style={{
                  fontWeight: "600",
                  fontFamily: "roboto",
                }}
        ...
        <section className="margintop">
          <div className="covid text-center">
            <h2 className="h2-fs">Return & Refunds</h2>
            <div className="thm-bg-clr dector mb-0"></div>
          </div>
          <div className="describe">
            <p>
